...
## File Organization
The repository includes two directories: `scripts` and `outcome`. There is also a word document containing the full simulation (_'updated_reproducible_code_simulating_aggregated_indices'_) code.
