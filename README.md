...
| BI Equation           | _BIi_ = _RMLi / HMLi_ * 100; _cBIgroup_ = (Σ(_BIi_)) / n                                               |  _aBigroup_ = (1/n) * Σ(_RMLi_) / (1/n) * Σ(_HMLi_)                |
| CI Equation           | _CIi_ = _TMLi / FBLi_ * 100; _aCIgroup_ = (Σ(_CIi_)) / n                                               |   _cCIgroup_ = (1/n) * Σ(_TMLi_) / (1/n) * Σ(_FBLi_)               |
