...
| BI Equation           | BIi = RMLi / HMLi * 100; BIgroup = (Σ(BIi)) / n                                               |  Bigroup = (1/n) * Σ(RMLi) / (1/n) * Σ(HMLi) * 100                |
| CI Equation           | CIi = TMLi / FBLi * 100; CIgroup = (Σ(CIi)) / n                                               |   CIgroup = (1/n) * Σ(TMLi) / (1/n) * Σ(FBLi) * 100               |
